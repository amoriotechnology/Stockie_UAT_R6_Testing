	...
	<section class="content">
	    ...
	    ?>
				...
				<div class="panel panel-default">
                    ...
                    <a href="<?php echo base_url('Cpurchase') ?>" class="btn btn-info m-b-5 m-r-2">Create Expenses</a>
                       <?php } ?>
                        </div>
                        <div class="col-sm-6">
...
<?php echo form_close() ?>
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
      ...
      <th data-column-id="id" class="id">ID</th>
        ...
        <th data-column-id="date" class="date">Purchase ID</th>
        <th data-column-id="Sale By">Supplier Name</th>
        <th data-column-id="Customer Name" class="Customer Name" >Purchase Date</th>
 ...
 <td><?php   echo $arr['purchase_id'];  ?></td>
 <td><?php   echo $arr['supplier_name'];  ?></td>
   <td><?php   echo $arr['purchase_date'];  ?></td>

  <td><?php   echo $arr['grand_total_amount'];  ?></td>
  <td><a class="btn btn-success btn-sm" style="background-color: #3ca5de;" href="<?php echo base_url()?>Cpurchase/purchase_update_form/<?php echo  $arr['purchase_id'];  ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a></td></tr>
     <?php   
$count++;
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.0.0-alpha.1/jspdf.plugin.autotable.js"></script>
    ...
    <input type="checkbox"  data-control-column="3" class="opt" checked="true"/>Purchase ID<br>
  
    <input type="checkbox"  data-control-column="4" class="opt" checked="true"/>Supplier Name<br>

    <input type="checkbox"  data-control-column="5" class="opt" checked="true"/>Purchase Date<br>
