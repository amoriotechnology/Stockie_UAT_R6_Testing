    ...
    <div class="modal-content" >
     ...
     <div class="row">
        <div class="col-sm-6" style="border: 1px solid #6666;text-align: center;">  <p style="font-weight: bold;">Standard</p>
            ...
            <br>
            <br>
         <a href="<?php echo base_url('Cinvoice/trucking_with_attachment_stand/').$arr['trucking_id'];  ?>" class="btn btn-default">Select</a></div>
        <div class="col-sm-6" style="border: 1px solid #6666;text-align: center;">  <p style="font-weight: bold;">Custom</p>
            ...
            <br>
            <br>
         <a class="btn btn-default" href="<?php echo base_url('Cinvoice/trucking_with_attachment_cus/').$arr['trucking_id'];  ?>">Select</a></div>
