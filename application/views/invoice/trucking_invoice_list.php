...
<td class="Trucking ID"><?php   echo $arr['trucking_id'];  ?></td>
  <td class="Container Pickup Date"><?php   echo $arr['container_pickup_date'];  ?></td>
  <td class="Delivery Date"><?php   echo $arr['delivery_date'];  ?></td>
  <td class="Total Amount"><?php   echo $arr['grand_total_amount'];  ?></td>
  <td class="Action"><a class="btn btn-success btn-sm" style="background-color: #3ca5de;" href="<?php echo base_url()?>Cinvoice/trucking_update_form/<?php echo  $arr['trucking_id'];  ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a></td></tr>
     <?php   
$count++;
