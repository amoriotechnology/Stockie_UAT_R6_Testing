...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <h1>Manage Profarma Invoice</h1>

            <small>Manage Profarma Invoice</small>
...
<div class="panel panel-default">
                    ...
                    <a href="<?php echo base_url('Cinvoice/profarma_invoice') ?>" class="btn btn-info m-b-5 m-r-2">Create profarma_invoice</a>
                       <?php } ?>
                        </div>
                        <div class="col-sm-6">
  ...
  <table class="table table-bordered" cellspacing="0" width="100%" id="ProfarmaInvList">
    <thead>
      ...
      <th data-column-id="id" class="ID">ID</th>
        ...
        <th data-column-id="Sale By" class="Sale By">Sale By</th>
        <th data-column-id="Customer Name" class="Customer Name" >Customer Name</th>
        <th data-column-id="date" class="Date">Date</th>
    ...
    <div class="modal-content" >
     ...
     <div class="row">
        <div class="col-sm-6" style="border: 1px solid #6666;text-align: center;">  <p style="font-weight: bold;">Standard</p>
            ...
            <br>
            <br>
         <a href="<?php echo base_url('Cinvoice/proforma_with_attachment_stand/').$arr['purchase_id'];  ?>" class="btn btn-default">Select</a></div>
        <div class="col-sm-6" style="border: 1px solid #6666;text-align: center;">  <p style="font-weight: bold;">Custom</p>
            ...
            <br>
            <br>
         <a class="btn btn-default" href="<?php echo base_url('Cinvoice/proforma_with_attachment_cus/').$arr['purchase_id'];  ?>">Select</a></div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.0.0-alpha.1/jspdf.plugin.autotable.js"></script>
    ...
    <input type="checkbox"  data-control-column="4" class="opt" value="Customer Name"/>Customer Name<br>

    <input type="checkbox"  data-control-column="5" class="opt" value="Date"/>Date<br>

    <input type="checkbox"  data-control-column="6" class="opt" value="Total"/>Total<br>

    <input type="checkbox"  data-control-column="7" class="opt" value="Action"/>Action<br>
