...
<?php echo form_close() ?>
 ...
 <td><?php   echo $arr['booking_no'];  ?></td>
   ...
   <td><?php   echo $arr['seal_no'];  ?></td>
<td><?php   echo $arr['ocean_export_tracking_id'];  ?></td>
  <td><?php   echo $arr['supplier_name'];  ?></td>
  <td><?php   echo $arr['invoice_date'];  ?></td>

  <td><?php   echo $arr['place_of_delivery'];  ?></td>
  <td><a class="btn btn-success btn-sm" style="background-color: #3ca5de;" href="<?php echo base_url()?>Cinvoice/ocean_export_tracking_update_form/<?php echo  $arr['ocean_export_tracking_id'];  ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a></td></tr>
     <?php   
$count++;
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.0.0-alpha.1/jspdf.plugin.autotable.js"></script>
	...
	<input type="checkbox"  data-control-column="8" class="opt" checked="true"/>Place of Delivery<br>
<input type="checkbox"  data-control-column="9" class="opt" checked="true"/>Action<br>
