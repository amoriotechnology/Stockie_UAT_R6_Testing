...
;
    ...
    public function insert_instant_cat() {
        ...
        if ($result == TRUE) {
             ...
             $this->session->set_userdata(array('message' => 'Category Added'));
            redirect(base_url('Cproduct'));
            
        } else {
              $this->session->set_userdata(array('message' =>'Already exists'));
            redirect(base_url('Cproduct'));
        }
    }
        ...
        if ($result == TRUE) {
                 $this->session->set_userdata(array('message' => 'Unit Added'));
            redirect(base_url('Cproduct'));
